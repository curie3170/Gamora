...
class XORBinaryNodefeatDataset(InMemoryDataset):
    def __init__(self, root, transform=None, pre_transform=None, highest_order = 16):
        self.highest_order = highest_order
        super(XORBinaryNodefeatDataset, self).__init__(root, transform, pre_transform, highest_order)
    ...
    def processed_file_names(self):
        return ['data_xor_binary_nodefeat.pt']
